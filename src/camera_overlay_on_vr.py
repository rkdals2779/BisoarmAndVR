...
transform_matrix.m[0][0] = 1.0; transform_matrix.m[0][1] = 0.0; transform_matrix.m[0][2] = 0.0; transform_matrix.m[0][3] = 0.0
transform_matrix.m[1][0] = 0.0; transform_matrix.m[1][1] = 1.0; transform_matrix.m[1][2] = 0.0; transform_matrix.m[1][3] = 0.0
transform_matrix.m[2][0] = 0.0; transform_matrix.m[2][1] = 0.0; transform_matrix.m[2][2] = 1.0; transform_matrix.m[2][3] = -1.0
...
capture = cv2.VideoCapture(4)  # /dev/video4
...
try:
	while True:
		...
		glBindTexture(GL_TEXTURE_2D, texture_id)
		glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA8, width, height, 0, GL_RGBA, GL_UNSIGNED_BYTE, frame_rgba.tobytes())
